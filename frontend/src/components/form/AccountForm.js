...
const AccountForm = () => {
    ...
    const { inputValues, handleInputValues, handleFormSubmit, handleLoginFormSubmit } = useForm();
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (isSignupVisible) {
            handleFormSubmit(e); // Call the signup function
        } else {
            handleLoginFormSubmit(e); // Call the login function
        }
    };
